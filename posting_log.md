...
- Foto: Giusi_Journalsorriso_41.jpg (sfondo_hook principale + sfondo_cta, da "Giusi - Casual Dez20 e Journal"); fascia info pagina 1 = giusi surf.jpg (MAGjCY4PZRw), stesso asset/crop dell'esempio reale; sfondo_quote = foto originale del template (MAFD12wZMVQ), stesso crop 1:1 dell'esempio reale
- Fix 2026-09-22 (due passaggi):
  1. Primo tentativo: avevo reso la fascia info di pagina 1 una foto "continua" con lo stesso sfondo principale (crop allineato) e messo una foto diversa (meditazione) su sfondo_quote — sbagliato su entrambi i punti secondo Giusi
  2. Corretto confrontando l'esempio reale non toccato (DAHVpz0P6HM): la fascia info di pagina 1 usa in realtà una foto diversa e sfocata (giusi surf.jpg), non lo stesso sfondo; sfondo_quote usa il crop 1:1 originale del template, non l'auto-crop di Canva. Ora entrambi replicano esattamente asset/crop dell'esempio reale. Vedi anche la correzione in `reel_template.md`'s "Photo sourcing"
